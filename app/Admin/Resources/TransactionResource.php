...
use App\Admin\Resources\TransactionResource\Pages\ManageTransactions;
        ...
        return $table
            ...
            ->filters([
                ...
                SelectFilter::make('subcategory')->attribute('subcategory_id')
                    ...
                    ->preload(),
            ], layout: FiltersLayout::AboveContentCollapsible)->filtersFormWidth(MaxWidth::FourExtraLarge)
            ->actions([
                EditAction::make(),
                DeleteAction::make(),
            ])
